...
public class PS1ShaderEditor : ShaderGUI {
	...
	public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties) {
		...
		//int affineMapping = material.GetInt("_AffineMapping");
		...
		//affineMapping = EditorGUILayout.Popup(Styles.uvMapText, affineMapping, Styles.uvNames);
		...
		if (EditorGUI.EndChangeCheck()) {
			...
			//material.SetInt("_AffineMapping", affineMapping);
		}
